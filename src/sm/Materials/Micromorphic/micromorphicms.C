...
namespace oofem {
  MicromorphicMaterialStatus :: MicromorphicMaterialStatus(int n, Domain *d, GaussPoint *g) : StructuralMaterialStatus(n, d, g), micromorphicVar(), micromorphicVarGrad(), micromorphicStress(), micromorphicStressGrad(), tempMicromorphicVar(), tempMicromorphicVarGrad(), tempMicromorphicStress(), tempMicromorphicStressGrad() 
{
